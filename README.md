# Ngbp-ui is Angular JS skeleton build with large apps in mind. Inspired by [angular seed](https://github.com/angular/angular-seed) and [ngbp](https://github.com/ngbp/ngbp)
